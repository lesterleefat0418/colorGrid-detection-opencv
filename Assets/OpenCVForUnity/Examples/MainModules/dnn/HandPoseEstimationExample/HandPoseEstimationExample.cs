        ...
        void Update()
        {
            ...
            if (webCamTextureToMatHelper.IsPlaying() && webCamTextureToMatHelper.DidUpdateThisFrame())
            {
                ...
                else
                {
                    ...
                    handPoseEstimator.visualize(rgbaMat, hands, true, true);
                }
        ...
        public class PalmDetector
        {
            ...
            public virtual void visualize(Mat image, Mat results, bool print_results = false, bool isRGB = false)
            {
                ...
                for (int i = 0; i < results.rows(); ++i)
                {
                    ...
                    {
                        Imgproc.circle(image, new Point(palm_landmarks[j], palm_landmarks[j + 1]), 2, (isRGB) ? new Scalar(255, 255, 255, 255) : new Scalar(255, 255, 255, 255), 2);
                    }*/
        ...
        public class HandPoseEstimator
        {
            ...
            public virtual void visualize(Mat image, List<Mat> results, bool print_results = false, bool isRGB = false)
            {
                ...
                for (int i = 0; i < results.Count; ++i)
                {
                    ...
                    // # draw handedness
                    Imgproc.putText(image, handedness_text + pos, new Point(bbox[0], bbox[1] + 12), Imgproc.FONT_HERSHEY_DUPLEX, 0.5, point_color);

                    // # Draw line between each key points
                    draw_lines(landmarks_screen_xy, false, 35);
                    ...
                    if (print_results)
                    {
                        ...
                        sb.AppendLine(String.Format("conf: {0:0.00}", conf[0]) + pos);
