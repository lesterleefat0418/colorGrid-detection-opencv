...
public class MultiTrackingBasedColor : MonoBehaviour
{
    ...
    public void OnWebCamTextureToMatHelperInitialized()
    {
        ...
        if(this.webcamImage != null) {
            this.webcamImage.texture = texture;
        }
        else
        {
        ...
        croppedMat = new Mat(webCamTextureMat.rows(), webCamTextureMat.cols(), CvType.CV_8UC4);

        thresholdMat = new Mat();
        hsvMat = new Mat();

        if(ColorGridDetection.Instance != null)
            ColorGridDetection.Instance.setWebcamSize((int)width, (int)height);
        //ColorGridDetection.Instance.setWebcamSize((int)width, (int)height);
    ...
    void Update()
    {
        if (webCamTextureToMatHelper.IsPlaying() && webCamTextureToMatHelper.DidUpdateThisFrame())
        {
            ...
            if(enableDetection) { 
                ...
                Utils.texture2DToMat(ColorGridDetection.Instance.GetCroppedTexture, croppedMat);
                ...
                Imgproc.cvtColor(rgbMat, croppedMat, Imgproc.COLOR_RGB2RGBA);
                Utils.matToTexture2D(croppedMat, ColorGridDetection.Instance.GetCroppedTexture);
            }
        }
    }
